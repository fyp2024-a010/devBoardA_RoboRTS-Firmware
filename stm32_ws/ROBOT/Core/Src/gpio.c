...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : PD7 PD5 PD4 PD3
                           PDPin PDPin PDPin PD11
                           PD10 PD9 PD8 */
  GPIO_InitStruct.Pin = GPIO_PIN_7|GPIO_PIN_5|GPIO_PIN_4|GPIO_PIN_3
                          |PIN_E_Pin|PIN_F_Pin|PIN_G_Pin|GPIO_PIN_11
                          |GPIO_PIN_10|GPIO_PIN_9|GPIO_PIN_8;
  GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOD, &GPIO_InitStruct);

  /*Configure GPIO pins : PA15 PA9 PAPin PAPin
                           PA4 PAPin PA6 PA5
                           PAPin PA7 */
  GPIO_InitStruct.Pin = GPIO_PIN_15|GPIO_PIN_9|PIN_S_Pin|PIN_T_Pin
                          |GPIO_PIN_4|PIN_U_Pin|GPIO_PIN_6|GPIO_PIN_5
                          |PIN_V_Pin|GPIO_PIN_7;
  GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /*Configure GPIO pins : PIPin PIPin PIPin PI3
                           PIPin PI8 PI9 PI4
                           PI1 PI10 PI11 PIPin */
  GPIO_InitStruct.Pin = PIN_Y_Pin|PIN_X_Pin|PIN_W_Pin|GPIO_PIN_3
                          |PIN_Z_Pin|GPIO_PIN_8|GPIO_PIN_9|GPIO_PIN_4
                          |GPIO_PIN_1|GPIO_PIN_10|GPIO_PIN_11|PIN_A_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /*Configure GPIO pins : PH15 PH13 PH14 PHPin
                           PHPin PHPin PH8 PH9
                           PH7 */
  GPIO_InitStruct.Pin = GPIO_PIN_15|GPIO_PIN_13|GPIO_PIN_14|PIN_B_Pin
                          |PIN_C_Pin|PIN_D_Pin|GPIO_PIN_8|GPIO_PIN_9
                          |GPIO_PIN_7;
  GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
