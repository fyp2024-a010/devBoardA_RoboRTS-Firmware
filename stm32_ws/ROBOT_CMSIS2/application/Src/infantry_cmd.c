...
//     osSignalSet(cmd_task_t, MANIFOLD2_CHASSIS_SIGNAL); //CMSIS_v1
//     osThreadFlagsSet(cmd_task_t, MANIFOLD2_CHASSIS_SIGNAL); //CMSIS_v2
//   }
//   return 0;
// }
...
//     osSignalSet(cmd_task_t, MANIFOLD2_CHASSIS_ACC_SIGNAL); //CMSIS_v1
//     osThreadFlagsSet(cmd_task_t, MANIFOLD2_CHASSIS_ACC_SIGNAL); //CMSIS_v2
//   }
//   return 0;
// }
