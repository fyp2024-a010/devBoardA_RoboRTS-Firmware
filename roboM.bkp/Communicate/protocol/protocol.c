...
/*
This is the main file of the protocol module. It is responsible for the initialization of the protocol module, 
the registration of the callback function, the sending of the data, the receiving of the data, and the processing of the 
data. It is the core of the protocol module.
*/
